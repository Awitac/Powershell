...
#
# IP Ports for Unite Axess Server Outbound
#    Unite TCP   443     Unite Axess (https) Standalone Axess server
#    Unite TCP   444     Unite Axess (https) Shared PS / Axess server
#
...
if (-not( Get-NetFirewallRule -DisplayName “Ascom Unite Axess 443-Outbound” -ErrorAction SilentlyContinue)) { 
$protocolName="Ascom Unite Axess 443"
$Description="Ascom Unite Axess HTTPS 443"
$protocol="TCP"
$portNumbers='443'
...
if (-not( Get-NetFirewallRule -DisplayName “Ascom Unite Axess 444-Outbound” -ErrorAction SilentlyContinue)) { 
$protocolName="Ascom Unite Axess 444"
$Description="Ascom Unite Axess HTTPS 444"
$protocol="TCP"
$portNumbers='444'
